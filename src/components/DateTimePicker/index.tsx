...
const DateTime = ({startDate, endDate, onChange, containerStyle}: any) => {
  ...
  return (
    <SafeAreaView>
      <View style={[styles.container, containerStyle]}>
        <TouchableOpacity onPress={() => handleOpen('showStart')} style={{paddingVertical: 10}}>
        ...
        <View style={styles.iconWrap}>
          <McIcon name="chevron-right" size={20} style={{zIndex: 100}} />
        </View>

        <TouchableOpacity onPress={() => handleOpen('showEnd')} style={{paddingVertical: 10}}>
